    ...
    <div class="container">
      <div class="card login-card">
        <div class="row no-gutters">
          <div class="col-md-5">
            <img src="https://img.wallpapersafari.com/desktop/1600/900/89/94/KycE8k.png" style="width: 110%; height: 100%;"> 
          </div>
          <div class="col-md-7">
            <div class="card-body">
              <div class="brand-wrapper">
               ...
               <div class="form-group" id="userid">
                      <input type="text" name="userid" id="userid" class="form-control" pattern ="[A-Za-z0-9]{3,10}" title=" UserId must contain uppercase, lowercase letters,digits & minimum of 3 characters" placeholder="Enter UserId" required/>
                  </div>
                  <div class="form-group" id="password">
                   <input type="password" name="password" id="password" class="form-control" pattern ="[A-Za-z0-9]{6,15}" title="must contain uppercase, lowercase letters ,digits & minimum of 8 characters" placeholder="Enter Password" required/>
                  </div>  
                  <input type="submit" class="btn btn-block login-btn mb-4" id="submit" value="Login">
                </form>
                <nav class="login-card-footer-nav" id="register">
