package com.claimsmanagement.claimsmodule.dto;
...
public class ClaimDto {
	...
	public ClaimDto(Long claimId, @NotNull @NotBlank(message = "Claim Status must not be empty") String claimstatus,
	...
	public String toString() {
		return "ClaimDto [claimId=" + claimId + ", claimstatus=" + claimstatus + ", claimeddate=" + claimeddate
